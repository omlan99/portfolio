...
const Banner = () => {
  return (
    <div className="grid lg:grid-cols-2 mb-[100px] py-28">
      <div className="pl-20">
        <div className="flex items-center pb-5">
          <div>
            <p className="font-semibold text-2xl">Hello, I am</p>
            <h2 className="font-bold text-4xl py-4">Amlan Dey</h2>
            <p className="font-semibold text-2xl">A passionate web developer</p>
          </div>
        </div>
        <div>
          <p className="text-xl pb-3">Feel Free to Conatact with me </p>
        ...
        <button className="btn btn-primary mt-6 btn-wide">Resume</button>
      </div>
